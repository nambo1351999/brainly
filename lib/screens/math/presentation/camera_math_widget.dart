...
class CameraMathWidget extends StatefulWidget {
  const CameraMathWidget({super.key});

  @override
  State<CameraMathWidget> createState() => _CameraMathWidgetState();
}
...
class _CameraMathWidgetState extends State<CameraMathWidget>
