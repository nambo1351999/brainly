...
class DrawMathWidget extends StatefulWidget {
  const DrawMathWidget({super.key});

  @override
  State<DrawMathWidget> createState() => _DrawMathWidgetState();
}

class _DrawMathWidgetState extends State<DrawMathWidget> {
